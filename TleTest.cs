...
namespace WorldMapWallpaper.Test
{
    class TleTest
    {
...
2 25544  51.6320 125.1332 0000980 198.3499 161.7454 15.49674063532122";
            ...
            try
            {
                ...
                var positionVelocity = Sgp4Propagator.Propagate(satellite, currentTime);
            ...
            try
            {
                ...
                if (fetchedTle != null)
                {
                    ...
                    {
                        var freshPv = Sgp4Propagator.Propagate(freshSatellite, DateTime.UtcNow);
